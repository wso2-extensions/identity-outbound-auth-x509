...
import org.wso2.carbon.sample.servlet.X509CertificateConstants;
import org.wso2.carbon.sample.servlet.X509CertificateDataHolder;
import org.wso2.carbon.sample.servlet.X509CertificateAuthenticator;
import org.wso2.carbon.sample.servlet.X509CertificateServlet;
...
public class X509CertificateServiceComponent {
    ...
    protected void activate(ComponentContext componentContext) {
        ...
        componentContext.getBundleContext().registerService(ApplicationAuthenticator.class.getName(),
                authenticator, props);
        Servlet servlet = new ContextPathServletAdaptor(new X509CertificateServlet(),
                X509CertificateConstants.SERVLET_URL);
        try {
    ...
    protected void setHttpService(HttpService httpService) {
        ...
        if (log.isDebugEnabled()) {
            log.info("HTTP Service is set in the X509 Certificate Servlet");
        }
    }

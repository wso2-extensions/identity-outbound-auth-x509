 ...
 * @scr.reference name="validation.registry.service" interface="org.wso2.carbon.registry.core.service.RegistryService"
...
public class X509CertificateValidationServiceComponent {
    ...
    protected void activate(ComponentContext context) {
        ...
        CertificateValidationUtil.addDefaultValidatorConfig();
